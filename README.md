...
Используйте на свой страх и риск, шанс бана не нулевой. Обязательно проверяйте пользовательское соглашенния мессенджера и текущее законодательство РФ, чтобы не получить проблем!

## 📞 Связь с разработчиком
- [Личные сообщения](https://t.me/endurra)
- [Тг канал, связанный с разработкой](https://t.me/codebykrais)
- [Чат для общения](https://t.me/codebykrais_chat)
...
- 🔄 Пересылка сообщений из Telegram в MAX
...
5. [Гайд по получению токена из веб-версии](https://t.me/codebykrais/160)
...
TG_ADMIN_ID= айди админа, который имеет доступ к привилегированным функциям (можно перечислить несколько через запятую без пробелов)
```
## 🚀 Запуск бота
